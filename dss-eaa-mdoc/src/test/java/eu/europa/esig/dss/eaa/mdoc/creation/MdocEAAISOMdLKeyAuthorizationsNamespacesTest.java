...
class MdocEAAISOMdLKeyAuthorizationsNamespacesTest extends AbstractMdocEAAPresentationTestIssuance {
    ...
    void init() {
        ...
        payloadParameters.setKeyAuthorizationsNamespaces(Collections.singletonList("org.iso.18013.5.1"));
