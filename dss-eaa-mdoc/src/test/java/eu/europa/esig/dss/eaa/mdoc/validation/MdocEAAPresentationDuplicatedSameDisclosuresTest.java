...
class MdocEAAPresentationDuplicatedSameDisclosuresTest extends AbstractMdocEAAPresentationTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument("src/test/resources/validation/mdoc-disclosure-duplicate-same.cbor");
    }
