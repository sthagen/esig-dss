...
class MdocEAAISOMdLKeyAuthorizationsNamespacesAndDataElementsTest extends AbstractMdocEAAPresentationTestIssuance {
    ...
    void init() {
        ...
        payloadParameters.setKeyAuthorizationsNamespaces(Collections.singletonList(MdocConstants.ISO18013_5_NAMESPACE));
