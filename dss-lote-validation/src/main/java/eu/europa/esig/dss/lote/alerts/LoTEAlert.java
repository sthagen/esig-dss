...
/**
 * The class to process events on LoTE
 *
 */
public class LoTEAlert extends DocumentAlert<LoTEInfo> {
	 ...
	 */
	public LoTEAlert(AlertDetector<LoTEInfo> detection, AlertHandler<LoTEInfo> handler) {
