...
/**
 * The class to process events on LoLoTE
 *
 */
public class LoLoTEAlert extends DocumentAlert<LoLoTEInfo> {
	 ...
	 */
	public LoLoTEAlert(AlertDetector<LoLoTEInfo> detection, AlertHandler<LoLoTEInfo> handler) {
