...
/**
 * Detects if an error in a LoTE validation occurred
 *
 */
public class LoTESignatureErrorDetection implements AlertDetector<LoTEInfo> {

	/**
	 * Default constructor
	 */
	public LoTESignatureErrorDetection() {
		// empty
	}
