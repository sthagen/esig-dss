...
class SDJWTCompactEAAPresentationWithKBSignatureDifferentCertX5CTest extends AbstractSDJWTEAAPresentationTestIssuance {
    ...
    void init() {
        ...
        payloadParameters.setDeviceX509CertificateChain(getCertEntity(ECDSA_521_USER).getCertificateChain());
