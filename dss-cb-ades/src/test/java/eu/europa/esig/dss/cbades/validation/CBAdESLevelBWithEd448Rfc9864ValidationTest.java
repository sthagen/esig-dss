...
class CBAdESLevelBWithEd448Rfc9864ValidationTest extends AbstractCBAdESTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument("src/test/resources/validation/cb-ades-level-b-ed448-rfc9864.cose");
    }
    ...
    protected void checkSignatureValue(DiagnosticData diagnosticData) {
        ...
        assertEquals(SignatureAlgorithm.ED448, signature.getSignatureAlgorithm()); // alg: -53
    }
