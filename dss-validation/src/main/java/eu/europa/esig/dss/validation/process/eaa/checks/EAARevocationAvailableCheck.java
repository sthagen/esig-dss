 ...
 *
 */
public class EAARevocationAvailableCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAARevocationAvailableCheck(final I18nProvider i18nProvider, final XmlSAV result,
    ...
    protected MessageTag getMessageTag() {
        return MessageTag.EAA_REV_AV;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.EAA_REV_AV_ANS;
    }
