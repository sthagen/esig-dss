 ...
 *
 */
public class EAARevocationPresentCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAARevocationPresentCheck(final I18nProvider i18nProvider, final XmlSAV result,
    ...
    protected MessageTag getMessageTag() {
        return MessageTag.EAA_REV_PR;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.EAA_REV_PR_ANS;
    }
