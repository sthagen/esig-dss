 ...
 *
 */
public class EAANotBeforePresentCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAANotBeforePresentCheck(I18nProvider i18nProvider, XmlSAV result,
    ...
    protected MessageTag getMessageTag() {
        return MessageTag.EAA_NBF_PRESENT;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.EAA_NBF_PRESENT_ANS;
    }
